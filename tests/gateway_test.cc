...
class GatewayTest : public testing::Test {
  protected:
    TradeSystem gateway{4};            // 交易所前置
    TradeSystem exchange{4};           // 纯撮合系统充当交易所
...
TEST_F(PureGatewayTest, MarketDataConstraint_PartialMatch) {
    ...
    std::vector<MarketDataItem> marketData;
    {
        MarketDataItem m1;
        m1.market = Market::XSHG;
        m1.securityId = "600030";
        m1.bidPrice = 8.5;
        m1.askPrice = 9.5;
        marketData.push_back(m1);
        MarketDataItem m2;
        m2.market = Market::XSHE;
        m2.securityId = "000001";
        m2.bidPrice = 19.0;
        m2.askPrice = 20.0;
        marketData.push_back(m2);
    }
